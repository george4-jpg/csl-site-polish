...
const PILLARS = [
  ...
  { title: "Content Library", desc: "Contribute member-safe case studies, briefings, research inputs, and category education to the CSL knowledge base." },
  { title: "Events & Webinars", desc: "Host or support CSL dinners, local roundtables, and webinars that bring leaders together around real challenges." },
  { title: "Workforce & Career Pathways", desc: "Support job listings, talent pathways, mentorship programs, and hiring visibility for the CSL community." },
  { title: "Strategic Relationships", desc: "Build trust-based relationships with leaders through structured engagement, not sales conversations." },
];
    ...
    <CSLLayout>
      ...
      <section className="csl-section">
        <div className="csl-container">
          ...
          <p className="text-sm mt-3 max-w-[560px] leading-relaxed" style={{ color: "#E2E8F0" }}>
      ...
      <section className="csl-section csl-section-dark">
        <div className="csl-container">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-3 max-w-[900px] mx-auto">
            ...
            <div className="glass-card gold-bar-left p-5 sm:col-span-2 lg:col-span-3">
      ...
      <section className="csl-section" style={{ borderBottom: "1px solid hsl(0 0% 100% / 0.08)" }}>
        <div className="csl-container">
          <div className="text-center mb-8">
            ...
            <p className="text-sm mt-2 max-w-[540px] mx-auto leading-relaxed" style={{ color: "#E2E8F0" }}>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-3 max-w-[900px] mx-auto">
            {["Relationship Development", "Thought Leadership Visibility", "Local Market Engagement", "Event Participation", "Content Contribution", "Category Association", "Hiring & Talent Visibility", "Strategic Brand Trust"].map((item) => (
              <div key={item} className="glass-card p-4 text-center">
                <span className="text-xs font-display font-semibold tracking-wide uppercase">{item}</span>
              </div>
            ))}
          </div>
        </div>
